...
def graduate():
    clear()
    print_slow("이 이후는 졸업이다... 여기까지 오느라 수고했다... 굿바이상명유니버시티")
    #이후 엔딩함수
...
def professor1():
    ...
    if total_brain > 10:
        ...
        if professor1 >= 35 and end_meet_pro1 >= 3:
        ...
        elif professor1 >= 25 and end_meet_pro1 >= 3:
        ...
        elif professor1 >= 15 and end_meet_pro1 >= 2:
        ...
        elif professor1 >= 5 and end_meet_pro1 >= 1:
             print_slow("박교수님 : 아 준영이 안녕~ 그런데 내가 지금 잠시 바빠서 기다려줄래? (；′⌒`) ?\n\n")
             print("________________선 택 창________________\n")
             print("|                                       |\n")
             print("| > 1. 바쁘시면 다음에 오겠습니다 !     |\n")
        ...
        elif professor1 >= 0 and end_meet_pro1 >= 2:
